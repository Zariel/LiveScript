...
exports.Assign = Assign = (function(superclass){
  ...
  prototype.compileNode = function(o){
    var ref$, left, i$, len$, op, right, reft, sign, name, lvar, del, that, protoSplit, dotSplit, code, empty, res;
    if (this.left instanceof Slice && this.op === '=') {
      return this.compileSplice(o);
    }
    if (this.left instanceof Chain && ((ref$ = this.left.tails) != null ? ref$[ref$.length - 1] : void 8) instanceof Call) {
      return this.compileFunctionAssign(o);
    }
  ...
  prototype.compileFunctionAssign = function(o){
    var params, ref$;
    params = (ref$ = this.left.tails)[ref$.length - 1].args;
    return Assign(Chain(this.left.head, this.left.tails.slice(0, -1)), Fun(params, Block(this.right), true, params.length > 1), this.op, this.logic).compile(o);
  };
